			...
			<main className={css.CV}>
				...
				<aside className={css.CV__aside}>
					<div className={css.CV__aside_Details}>
						...
						<div>
							<h3>EMAIL</h3>
							<span>DanielCarrete_Dev@outlook.com</span>
						</div>
						<div>
							<h3>WEBSITE</h3>
				...
				<section className={css.CV__main}>
					<article>
						...
						<p>
							...
							etc., also a programming, music and science
							enthusiast, dedicated to always learning new things.
							I am looking for an entry position in a great
							company to be a hard-working asset to any team, to
							learn, grow and develop long-term.
						</p>
					</article>
					<article>
						<h2>EXPERIENCE</h2>
						<div>
							<h3>Guitar NextJs</h3>
							<p>
								Web application developed with NextJs, using
								application deployment skills, API creation, and
								rendering of API data on the front-end.
							</p>
							<p>
								https://daniel-carrete.vercel.app/projects/next-js
							</p>
						</div>
						<div>
							<h3>Cross Port</h3>
							<p>
								An application designed to transfer files on a
								local network or the internet, developing
								backend and front-end skills, using frameworks
								and libraries such as ElectronJs, Exppress.js,
								ReactJs.
							</p>
							<p>
								https://daniel-carrete.vercel.app/projects/cross-port
							</p>
						</div>
					</article>
					<article>
					...
					<article>
						<span>
							<h2>KEY QUALIFICATIONS & RESPONSIBILITIES</h2>
						</span>
						<p>
							- Planned, developed, tested, deployed and
							maintained web applications.
						</p>
						<p>
							- Provided effective troubleshooting and remediation
							for web applications.
						</p>
						<p>
							- Effectively translated client requirements into
							application designs and systems requirements.
						</p>
						<p>
							- Followed policies and procedures related to
							application methods and quality standards at all
							times.
						</p>
					</article>
				</section>
